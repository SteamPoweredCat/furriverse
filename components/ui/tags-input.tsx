    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-1 p-1 rounded-lg bg-background overflow-hidden  border border-gray-600",
            {
        ...
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative px-1 rounded flex items-center gap-1 truncate aria-disabled:opacity-50 aria-disabled:cursor-not-allowed focus-visible:outline-0",
              )}
              >
          ...
          <Input
            ...
            className={cn(
              "outline-0 border-none h-7 min-w-fit flex-1 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0 placeholder:text-muted-foreground px-1 bg-gray-700 placeholder:font-extralight",
